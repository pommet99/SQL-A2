...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 22, 2019 at 07:58 PM
...
CREATE TABLE IF NOT EXISTS `clients` (
  ...
  `ID de la mission` int(255) NOT NULL,
  PRIMARY KEY (`ID`)
...
CREATE TABLE IF NOT EXISTS `missions` (
  `ID` int(11) NOT NULL,
  `ID des collaborateurs` int(255) NOT NULL,
  `ID des clients` int(255) NOT NULL,
  `ID des qualifications` int(255) NOT NULL,
  `Date de debut` date NOT NULL,
  `Date de fin` date NOT NULL,
  `Budget` int(255) NOT NULL,
  `Duree de travail` int(255) NOT NULL,
  `Type de mission` varchar(255) NOT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `qualifications` (
  `ID` int(11) NOT NULL,
  `ID des collaborateurs` int(255) NOT NULL,
  `Annees d'experience` int(255) NOT NULL,
